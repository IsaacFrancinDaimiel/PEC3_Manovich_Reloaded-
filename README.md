...
1. **Escaneo del entorno**: El escaneo del entorno en tiempo real da paso a otra serie de características clave, ya que esto nos permitirá integrar modelos holográficos de una forma totalmente fiel a nuestro mundo real.
2. **Modelado 3D**: En un entorno médico donde poder practicar ciertas habilidades sanitarias se hace muy complicado por lo obvio, será de gran ayuda tener modelos tridimensionales para poder recrear desde operaciones médicas comunes hasta las más avanzadas. El hecho de poder manipular, girar, explorar sin ningún tipo de riesgo para el paciente y en un entorno totalmente seguro para el profesional hace de esta una opción muy interesante para este campo, ya que podremos simular cualquier situación médica.
